...
import com.example.doctorappointment.ui.theme.TextColorTitle
        ...
        Column(
            ...
            Button(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(top = 20.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color(0xFF6384FF).copy(alpha = 0.1f)),
                onClick = { /*TODO*/ }
            ) {
             Text(
                 text = "Details",
...
@Preview()
@Composable
fun ScheduleDoctorCardPreview(modifier: Modifier = Modifier) {
    ScheduleDoctorCard()
}